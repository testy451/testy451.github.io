...
function NavContent() {
  ...
  const checkPage = useCallback((match, location, page) => {
    ...
    if ((currentPath.indexOf("stake") >= 0 || currentPath.indexOf("choose_bond") >= 0) && page === "stake") {
      return true;
    }
    if ((currentPath.indexOf("community") >= 0 || currentPath.indexOf("choose_bond") >= 0) && page === "community") {
      return true;
    }
    return false;
  }, []);
            ...
            <div className="dapp-nav" id="navbarNav">
              ...
              >
                <Typography variant="h6">
                  ...
                  Dashboard<div style={{fontSize:'11px', color:'#999'}}>&nbsp;&nbsp;(Coming Soon)</div>
                </Typography>
              </Link>
              ...
              <Link
                ...
                to="/community"
                isActive={(match, location) => {
                  return checkPage(match, location, "community");
                }}
                className={`button-dapp-menu ${isActive ? "active" : ""}`}
              >
                <Typography variant="h6">
...
{/*  for mint. Code 2022.02.20
              ...
              >
                <Typography variant="h6" className="fxCenter">
                  ...
                  Bond<div style={{fontSize:'11px', color:'#999'}}>&nbsp;&nbsp;(Coming Soon)</div>
                </Typography>
              </Link>
              ...
              >
                <Typography variant="h6">
                  ...
                  Calculator<div style={{fontSize:'11px', color:'#999'}}>&nbsp;&nbsp;(Coming Soon)</div>
                </Typography>
              </Link>
              <Link
                component={NavLink}
                ...
                to="#"
                isActive={(match, location) => {
                  return checkPage(match, location, "govenance");
                }}
                className={`button-dapp-menu ${isActive ? "active" : ""}`}
              >
                <Typography variant="h6">
                  <SvgIcon color="primary" component={GovIcon} />
                  Govenance<div style={{fontSize:'11px', color:'#999'}}>&nbsp;&nbsp;(Coming Soon)</div>
                </Typography>
              </Link>
            </div>
          </div>
