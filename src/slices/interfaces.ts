...
export interface IBaseAllowanceAsyncThunk extends IBaseAsyncThunk {
  readonly address: string;
  readonly tokenKind: number; 
}

export interface IBaseAddressTokenAsyncThunk extends IBaseAddressAsyncThunk {
  readonly tokenKind: number;
}
...
export interface ICalcUserCBondDetailsAsyncThunk extends IBaseAddressAsyncThunk, IBaseBondAsyncThunk {
  readonly lpPrice: string;
}
...
export interface IBaseBondAddressAsyncThunk extends IBaseBondAsyncThunk {
  readonly address: string;
}
...
export interface IPurchaseCSTPAsyncThunk extends IBaseAsyncThunk {
...
export interface IPurchaseCSTAsyncThunk extends IBaseAsyncThunk {
  readonly amount: number;
  readonly address: string;
}