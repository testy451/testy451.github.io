  ...
  return (
    <TableRow id={`${bondName}--claim`}>
      ...
      <TableCell align="center">
        {bond.pendingPayout ? trim(bond.pendingPayout, 2) : <Skeleton width={100} />}
      </TableCell>
      <TableCell align="center">
        {bond.pendingPayout ? trim(currentAprs[bond.id], 2) + '%' : <Skeleton width={100} />}
      </TableCell>
      <TableCell align="right" style={{ whiteSpace: "nowrap" }}>
        {isAppLoading ? <Skeleton /> : vestingPeriod()}
      </TableCell>
      <TableCell align="center">{bond.interestDue ? trim(bond.interestDue, 2) : <Skeleton width={100} />}</TableCell>
