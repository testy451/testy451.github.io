...
import { ClaimBondTableData, ClaimBondCardData } from "./CClaimRow";
...
import { calculateUserCBondDetails } from "src/slices/AccountSlice";
import CardHeader from "../../components/CardHeader/CardHeader";
import { useWeb3Context } from "src/hooks/web3Context";
import useCBonds from "src/hooks/CBonds";
import {
  Button,
  Box,
  Paper,
...
function ClaimBonds({ activeBonds }) {
  ...
  console.log("activeBonds:", numberOfBonds, "---", activeBonds);
      ...
      {numberOfBonds > 0 && (
        <Zoom in={true}>
          <Paper className="ohm-card claim-bonds-card">
            <CardHeader title="Your Staking Info" />
            <Box>
              {!isSmallScreen && (
                <TableContainer>
